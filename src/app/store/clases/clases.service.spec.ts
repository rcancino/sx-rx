...
describe('Service: ClasesService', () => {
  let service: ClasesService = null;
  ...
  beforeEach(inject([ClasesService, MockBackend], (clasesService: ClasesService, mockBackend: MockBackend) => {
