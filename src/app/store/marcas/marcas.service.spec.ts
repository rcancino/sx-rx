...
describe('Service: MarcasService', () => {
  let service: MarcasService = null;
  ...
  beforeEach(inject([MarcasService, MockBackend], (marcasService: MarcasService, mockBackend: MockBackend) => {
