...
describe('Service: ComprasService', () => {
  let service: ComprasService = null;
  ...
  beforeEach(inject([ComprasService, MockBackend], (comprasService: ComprasService, mockBackend: MockBackend) => {
