...
describe('Service: ProveedoresService', () => {
  let service: ProveedoresService = null;
  ...
  beforeEach(inject([ProveedoresService, MockBackend], (proveedoresService: ProveedoresService, mockBackend: MockBackend) => {
